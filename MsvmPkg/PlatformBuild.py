...
REQUIRED_REPOS = ('MU_BASECORE', 'Common/MU', 'Common/MSCORE_INTERNAL', 'Common/MU_TIANO', 'Silicon/ARM/MU_TIANO')
PROJECT_SCOPE = ('hyperv',)

MODULE_PKGS = ('MU_BASECORE', 'Common/MU', 'Common/MSCORE_INTERNAL', 'Common/MU_TIANO', 'Silicon/ARM/MU_TIANO')
