...
//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_UNICODE_STRING_TABLE mBiosVideoControllerNameTable[] = {
  {
    "eng;en",
    (CHAR16 *)L"Msvm S3 Controller"
  },
  {
    NULL,
    NULL
