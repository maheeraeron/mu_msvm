...
EfiBuildCrashDumpModuleList()
{
    ...
    stringSpace = BdModuleListCount * (sizeof(DUMP_STRING) + STRING_TABLE_ENTRY_LENGTH);
    tableSize   = (BdModuleListCount * sizeof(DUMP_DRIVER_ENTRY64)) + stringSpace;
    ...
    pModuleBlock->LoadedModuleListPtr = (UINT64)&BdModuleList;
    pModuleBlock->ModuleCount = BdModuleListCount;
    ...
    )
{
    ...
    if (BdDumpType == MemoryDumpDisabled)
    {
        status = RETURN_NOT_READY;
        goto Exit;
    }

    ZeroMem(BdDumpBuffer.Buffer, BdDumpBuffer.BufferSize);
    ...
    // Update header
    //
    pInfo->BlockCount  = BdDumpBuffer.BlockCount;
    ...
    )
{
    ...
    pMemoryRegion->Address = (UINT64)BdPcr.NtTib.StackBase;
    pMemoryRegion->Size    = (UINT32)(UINTN)BdPcr.NtTib.StackLimit;
    ...
    pMemoryRegion->Address = (UINT64)BdPrcb;
    pMemoryRegion->Size    = sizeof(*BdPrcb);
    ...
    pMemoryRegion->Address = (UINT64)&BdDebuggerDataBlock;
    pMemoryRegion->Size = sizeof(BdDebuggerDataBlock);
