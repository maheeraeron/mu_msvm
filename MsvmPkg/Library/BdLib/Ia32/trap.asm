...
;--
        ...
        align   16
        public  _BdDebugTrapOrFault
_BdDebugTrapOrFault proc
...
;--
        ...
        align 16
        public _BdUnhandledException
_BdUnhandledException proc
...
;--
        ...
        align   16
        public  _BdBreakpointTrap
_BdBreakpointTrap proc
; .FPO (0, 0, 0, 0, 0, FPO_TRAPFRAME)
...
;--
        ...
        align   16
        public  _BdGeneralProtectionFault
_BdGeneralProtectionFault proc
; .FPO (0, 0, 0, 0, 0, FPO_TRAPFRAME)
...
BdGeneralProtectionFault10:                            ;
        ...
        and     edx, 0FFFFH             ;
        call    _EfiCommonExceptionDispatch             ; dispatch exception
        jmp     BdGeneralProtectionFault10             ; repeat

_BdGeneralProtectionFault endp
...
;--
        ...
        align   16
        public  _BdFastFailTrap
_BdFastFailTrap proc
; .FPO (0, 0, 0, 0, 0, FPO_TRAPFRAME)
...
;--
        ...
        align   16
        public  _BdAssertionFailureTrap
_BdAssertionFailureTrap proc
; .FPO (0, 0, 0, 0, 0, FPO_TRAPFRAME)
...
;--
        ...
        align   16
        public  _BdDebugServiceTrap
_BdDebugServiceTrap proc
; .FPO (0, 0, 0, 0, 0, FPO_TRAPFRAME)
...
;
        ...
        call    [_BdTrapRoutine]     ; call dispatch routine
        pop     ecx
        pop     ecx
        pop     ebp
