...
void BdDivideError() {
    DEBUG((DEBUG_INFO, "DDD Called BdDivideError \n"));
}


void BdNmiInterrupt() {
    DEBUG((DEBUG_INFO, "DDD Called BdNmiInterrupt \n"));
}


void BdOverflowTrap() {
    DEBUG((DEBUG_INFO, "DDD Called BdOverflowTrap \n"));
}


void BdBoundFault() {
    DEBUG((DEBUG_INFO, "DDD Called BdBoundFault \n"));
}


void BdInvalidOpcodeFault() {
    DEBUG((DEBUG_INFO, "DDD Called BdInvalidOpcodeFault \n"));
}


void BdNpxNotAvailableFault() {
    DEBUG((DEBUG_INFO, "DDD Called BdNpxNotAvailableFault \n"));
}


void BdDoubleFault() {
    DEBUG((DEBUG_INFO, "DDD Called BdDoubleFault \n"));
}


void BdInvalidTss() {
    DEBUG((DEBUG_INFO, "DDD Called BdInvalidTss \n"));
}


void BdFloatingPointFault() {
    DEBUG((DEBUG_INFO, "DDD Called BdFloatingPointFault \n"));
}


void BdAlignmentFault() {
    DEBUG((DEBUG_INFO, "DDD Called BdAlignmentFault \n"));
}


void BdMachineCheckAbort() {
    DEBUG((DEBUG_INFO, "DDD Called BdMachineCheckAbort \n"));
}


void BdXmmException() {
    DEBUG((DEBUG_INFO, "DDD Called BdXmmException \n"));
}
