/** @file
  ...
  TODO-cho: This is a copy of PL011SerialPortLib, with the register base being
  set to a difference PCD for use in KdDxe. This is due to being unable to override
  FixedAtBuild PCDs for a consumed library from a driver.
  ...
  )
{
  ...
  return PL011UartInitializePort (
           (UINTN)FixedPcdGet64 (PcdCom1RegisterBase),
...
{
  return PL011UartWrite ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase), Buffer, NumberOfBytes);
}
...
{
  return PL011UartRead ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase), Buffer, NumberOfBytes);
}
...
{
  return PL011UartPoll ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase));
}
/**
...
{
  return PL011UartSetControl ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase), Control);
}
...
{
  return PL011UartGetControl ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase), Control);
}
