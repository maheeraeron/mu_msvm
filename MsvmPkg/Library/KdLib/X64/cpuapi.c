...
Author:
    ...
    Jamie Schwartz (jamschw) 15-Jun-2004 - Based on the x86 implementation in
        boot\environ\lib\EfiKd\i386\cpuapi.c.
...
--*/
{
    ...
    if (NT_SUCCESS(ManipulateState->u.Continue2.ContinueStatus) != FALSE) 
    {
        ...
        EfiKdPrcb->ProcessorState.SpecialRegisters.KernelDr6 = 0;
        EfiKdPrcb->ProcessorState.SpecialRegisters.KernelDr7 =
...
--*/
{
    ...
    case DEBUG_CONTROL_SPACE_PCR:
        *(PKPCR *)(AdditionalData->Buffer) =
            (PKPCR)CONTAINING_RECORD(EfiKdPrcb, KPCR, Prcb);
    ...
    case DEBUG_CONTROL_SPACE_PRCB:
        *(PKPRCB *)(AdditionalData->Buffer) = EfiKdPrcb;
    ...
    case DEBUG_CONTROL_SPACE_KSPECIAL:
        ...
        EfiKdMoveMemory (AdditionalData->Buffer,
                      (PVOID)&(EfiKdPrcb->ProcessorState.SpecialRegisters),
                      Length);
...
--*/
{
    ...
    case DEBUG_CONTROL_SPACE_KSPECIAL:
        Length = min(Length, sizeof(KSPECIAL_REGISTERS));
        EfiKdMoveMemory((PVOID)&(EfiKdPrcb->ProcessorState.SpecialRegisters),
