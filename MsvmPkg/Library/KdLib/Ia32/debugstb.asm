...
Routine Description:
    ...
    EfiKdArchInitialize.  For x86, this just involves freeing the memory
...

{
    ...
    case BREAKPOINT_PROMPT:
    {
        ...
        do {
        } while (EfiKdPromptString(&Output, &Input) != FALSE);
    ...
    case BREAKPOINT_LOAD_SYMBOLS:
        ...
        if (EfiKdDebuggerNotPresent == FALSE)
        {
            EfiKdReportLoadSymbolsStateChange((PSTRING)ExceptionRecord->ExceptionInformation[1],
                                              SymbolInfo,
                                              UnloadSymbols,
                                              ContextRecord);
        }
    ...
    case BREAKPOINT_GET_TABLE:
        TrapFrame->Eax = (ULONG)&EfiKdDebugTable;
        TrapFrame->Eip += 1;
        ReturnValue = TRUE;
        break;
...

{
    ...
    DEBUG((DEBUG_INFO, "DDD EfiKdArchStart\n"));
    EfiKdTrapRoutine = (UINT32)EfiKdDispatchException;
