...
#define FP_MFRAME_MENU_CELL_NORMAL_COLOR         &mLightGray1Color      // Master Frame: Menu cell background color (normal cell).
#define FP_MFRAME_MENU_CELL_HOVER_COLOR          &mLightGray2Color      // Master Frame: Menu cell background color (cell with mouse pointer hovering over it).
#define FP_MFRAME_MENU_CELL_SELECT_COLOR         &mMediumBlueColor      // Master Frame: Menu cell background color (selected cell).
#define FP_MFRAME_MENU_CELL_GRAY_COLOR           &mLightGray2Color      // Master Frame: Menu cell background color (selected cell).
...
#define FP_FCANVAS_BACKGROUND_COLOR              &mWhiteColor           // Form Canvas: Background color.
...
// Surface Refresh Formset GUID
//
#define SURFACE_REFRESH_FORMSET_GUID                                               \
  {                                                                                \
